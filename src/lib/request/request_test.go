...
func TestGetNextTram(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			responseInfo: &traveline.ResponseInfo{
				LineName:              "magic carpet",
				DirectionName:         "Xanadu",
				AimedDepartureTime:    &nextTramTime,
				ExpectedDepartureTime: &differsNextTramTime,
			},
			expectedMessage: "Your next magic carpet tram to Xanadu is due at 12:34PM, but is expected at 12:37PM",
		},
		{
			...
			expectedMessage: "Your next magic carpet tram to Xanadu is due at 12:34PM",
		},
		{
